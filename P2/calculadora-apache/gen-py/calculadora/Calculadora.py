...
class Client(Iface):
    ...
    def sumavector(self, v1, v2):
        ...
        """
        self.send_sumavector(v1, v2)
        return self.recv_sumavector()

    def send_sumavector(self, v1, v2):
    ...
    def restavector(self, v1, v2):
        ...
        """
        self.send_restavector(v1, v2)
        return self.recv_restavector()

    def send_restavector(self, v1, v2):
    ...
    def multiplicacionvector(self, v1, v2):
        ...
        """
        self.send_multiplicacionvector(v1, v2)
        return self.recv_multiplicacionvector()

    def send_multiplicacionvector(self, v1, v2):
        self._oprot.writeMessageBegin('multiplicacionvector', TMessageType.CALL, self._seqid)
        args = multiplicacionvector_args()
        args.v1 = v1
        args.v2 = v2
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_multiplicacionvector(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = multiplicacionvector_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "multiplicacionvector failed: unknown result")
    ...
    def multiplicacionvectorescalar(self, v, escalar):
        ...
        """
        self.send_multiplicacionvectorescalar(v, escalar)
        return self.recv_multiplicacionvectorescalar()

    def send_multiplicacionvectorescalar(self, v, escalar):
        self._oprot.writeMessageBegin('multiplicacionvectorescalar', TMessageType.CALL, self._seqid)
        args = multiplicacionvectorescalar_args()
        args.v = v
    ...
    def recv_multiplicacionvectorescalar(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = multiplicacionvectorescalar_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "multiplicacionvectorescalar failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["multiplicacionvector"] = Processor.process_multiplicacionvector
        self._processMap["multiplicacionvectorescalar"] = Processor.process_multiplicacionvectorescalar
    ...
    def process_sumavector(self, seqid, iprot, oprot):
        ...
        result = sumavector_result()
        try:
            result.success = self._handler.sumavector(args.v1, args.v2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_restavector(self, seqid, iprot, oprot):
        ...
        result = restavector_result()
        try:
            result.success = self._handler.restavector(args.v1, args.v2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_multiplicacionvector(self, seqid, iprot, oprot):
        args = multiplicacionvector_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = multiplicacionvector_result()
        try:
            result.success = self._handler.multiplicacionvector(args.v1, args.v2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("multiplicacionvector", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_multiplicacionvectorescalar(self, seqid, iprot, oprot):
        args = multiplicacionvectorescalar_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = multiplicacionvectorescalar_result()
        try:
            result.success = self._handler.multiplicacionvectorescalar(args.v, args.escalar)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("multiplicacionvectorescalar", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class multiplicacionvector_args(object):
    """
    Attributes:
     - v1
     - v2
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('multiplicacionvector_args')
        if self.v1 is not None:
            oprot.writeFieldBegin('v1', TType.LIST, 1)
            oprot.writeListBegin(TType.I32, len(self.v1))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multiplicacionvector_args)
multiplicacionvector_args.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'v1', (TType.I32, None, False), None, ),  # 1
    (2, TType.LIST, 'v2', (TType.I32, None, False), None, ),  # 2
)
...
class multiplicacionvector_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('multiplicacionvector_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.I32, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multiplicacionvector_result)
multiplicacionvector_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.I32, None, False), None, ),  # 0
)


class multiplicacionvectorescalar_args(object):
    """
    Attributes:
     - v
     - escalar
    ...
    def __init__(self, v=None, escalar=None,):
        self.v = v
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('multiplicacionvectorescalar_args')
        if self.v is not None:
            oprot.writeFieldBegin('v', TType.LIST, 1)
            oprot.writeListBegin(TType.I32, len(self.v))
            for iter69 in self.v:
                oprot.writeI32(iter69)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.escalar is not None:
            oprot.writeFieldBegin('escalar', TType.I32, 2)
            oprot.writeI32(self.escalar)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multiplicacionvectorescalar_args)
multiplicacionvectorescalar_args.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'v', (TType.I32, None, False), None, ),  # 1
    (2, TType.I32, 'escalar', None, None, ),  # 2
)


class multiplicacionvectorescalar_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('multiplicacionvectorescalar_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.I32, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multiplicacionvectorescalar_result)
multiplicacionvectorescalar_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.I32, None, False), None, ),  # 0
)
